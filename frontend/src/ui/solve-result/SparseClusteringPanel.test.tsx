...
function result(patch: Partial<SparseClusteringResultDto> = {}): SparseClusteringResultDto {
  return {
    ...
    warnings: [],
    quality: { boundary_port_type_count: 4, size_imbalance: 1, boundary_flow_amount: 2 },
    ...
    boundary_flows: { items: [{ source_cluster_id: 1, target_cluster_id: 2, item_id: 'gear', estimated_flow: 4 }], total_count: 1, truncated: false },
