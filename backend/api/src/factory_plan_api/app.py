...
job_store = SolveJobStore(max_workers=DEFAULT_API_LIMITS.max_solve_workers)
MAX_PACKAGE_UPLOAD_BYTES = DEFAULT_API_LIMITS.max_package_upload_bytes
MAX_STORED_PACKAGES = DEFAULT_API_LIMITS.max_stored_packages
